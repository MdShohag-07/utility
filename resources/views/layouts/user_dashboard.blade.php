        ...
        <section class="content-cards mb-6 md:mb-8">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div class="content-card-item">
                     ...
                     <img src="{{ asset('images/utility-logo.svg') }}" alt="Feature 1">
                  ...
                  <div class="content-card-item">
                      {{-- Replace with dynamic content/image --}}
                     <img src="{{ asset('images/utility-logo.svg') }}" alt="Feature 2">
                     <div class="card-item-body">
...
<style>
    ...
    .offer-badge {
        position: absolute;
        top: 8px; /* Keep inside the banner to avoid clipping */
        left: 12px;
        ...
        z-index: 5; /* Ensure it stays above image/text */
        box-shadow: 0 2px 6px rgba(0,0,0,0.15);
        border: 1px solid rgba(255,255,255,0.7);
        text-shadow: 0 1px 1px rgba(0,0,0,0.25);
    }
    .offer-content { display: flex; flex-direction: column; gap: 1rem; padding-top: 2.25rem; /* Add space so badge doesn't overlap */ }
