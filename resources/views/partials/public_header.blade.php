        ...
        <div class="header-logo">
            ...
            @auth
                ...
                <a href="{{ route('my-account.index')  }}">
                    <img src="{{ $siteLogoUrl ?? asset('images/utility-logo.svg') }}" alt="{{ config('app.name', 'Logo') }} - My Account" height="36">
                </a>
            @else
                {{-- If user is a guest, link logo to the public homepage --}}
                <a href="{{ route('home') }}">
                    <img src="{{ $siteLogoUrl ?? asset('images/utility-logo.svg') }}" alt="{{ config('app.name', 'Logo') }}" height="36">
                </a>
            @endauth
        </div>
                    ...
                    <div class="relative">
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('my-account.profile.edit')"> {{-- Assuming profile.edit is within my-account group --}}
                                    {{ __('Profile Settings') }}
                                </x-dropdown-link>
